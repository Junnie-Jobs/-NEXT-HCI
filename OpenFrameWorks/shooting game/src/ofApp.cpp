...
//void ofApp::update_enemy_boss(){
//    
//    for(int i=0;i<enemy_bosses.size();i++) {
//        enemy_bosses[i].update();
//        if (enemy_bosses[i].pos.x - enemy_bosses[i].width/2 < 0 || enemy_bosses[i].pos.y + enemy_bosses[i].width/2 > ofGetHeight()) {
//            enemy_bosses.erase(enemy_bosses.begin()+i);
//        }
//    }
//
//}
...
void ofApp::check_bullet_collision(void) { for (int i = 0; i < bullets.size(); i++) {
...
void ofApp::check_item_collision(void) {
    for (int i = 0; i < items.size(); i++) {
...
void ofApp::check_potion_collision(void) {
    for (int i = 0; i < potions.size(); i++) {
...
void ofApp::check_missile_item_collision(void) {
    for (int i = 0; i < missiles.size(); i++) {
